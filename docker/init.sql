...
(
	...
	constraint order_cancel_reason_fk
		foreign key (cancel_reason) references reasons (reason_id)
);
...
INSERT INTO reasons(description) VALUES('Could not contact client');
INSERT INTO reasons(description) VALUES('No stock');
INSERT INTO reasons(description) VALUES('Purchase failure');
